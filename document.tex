...
%% CHECK: Conformation wirklich richtig?
...
%% CHECK: b3lyp muss ja evtl nicht nochmal ausgegraben werden. Dafür
% vllt pw6b95.
%% CHECK: Experiment? 
% Table generated by Excel2LaTeX from sheet 'Tabelle1'
\begin{table}[t]
...
% Table generated by Excel2LaTeX from sheet 'Reaction energies'
%\newcommand\Colfix{R{3cm}}
\newcolumntype{D}{>{\raggedleft\arraybackslash}p{1.8cm}}
...
\begin{table*}[htb]
  ...
  energies are computed in the $\btlyp$ functional.}
    ...
    %\hline
    & & & & & & & &\\[-10pt]
    \multicolumn{3}{l|}{} & \multicolumn{2}{c||}{Surface reaction energy} & \multicolumn{2}{c|}{Gas phase reaction energy} &\multicolumn{3}{l}{}\\[2pt]
    \cline{4-7}
    & & & & & & & &\\[-10pt]
    \multicolumn{3}{l|}{Surface reaction} & $E$ & $\ezp$ & $E$ & $\ezp$ & \multicolumn{3}{l}{Gas phase reaction}\\[2pt]
    \hline
    & & & & & & & &\\[-10pt]
...
% $\sur\hto+^1\te O\gas$ &\defskip$\rightarrow \sur\htot$ & -1137.74 & -1128.81 & -1143.98 & -1130.33 & $\hto\gas+^1\te O\gas$ &\defskip$\rightarrow \hto\tgas$\\
%     $\sur\ho+\ho\gas$ &\defskip$\rightarrow \sur\htot$ & -205.99 & -182.80 & -209.22 & -184.03 & $\ho\gas+\ho\gas$ &\defskip$\rightarrow \hto\tgas$\\
%     $\sur\ho+\te H\gas$ &\defskip$\rightarrow  \sur\hto$ & -512.17 & -475.86 & -509.16 & -475.57 & $\ho\gas+\te H\gas$ &\defskip$\rightarrow  \hto\gas$ \\
%     $\sur\ho+^3\te O\gas$ &\defskip$\rightarrow  \sur\hot$ & -308.46 & -294.05 & -287.97 & -273.12 & $\ho\gas+^3\te O\gas$ &\defskip$\rightarrow  \te {HO}\tgas$\\
%     $\sur^3\te O+\ho\gas$ &\defskip$\rightarrow  \sur\hot$ & -337.30 & -314.13 & -287.97 & -273.12 & $^3\te O\gas+\ho\gas$ &\defskip$\rightarrow  \te {HO}\tgas$\\
%     $\sur\hot+\te H\gas$ &\defskip$\rightarrow  \sur\htot$ & -345.72 & -314.89 & -369.44 & -337.05 & $\te {HO}\tgas+\te H\gas$ &\defskip$\rightarrow  \hto\tgas$\\
%     $\sur^1\ot+\te H\gas$ &\defskip$\rightarrow  \sur\hot$ & -441.66 & -406.73 & -384.59 & -357.44 & $^1\te O\tgas+\te H\gas$ &\defskip$\rightarrow  \te {HO}\tgas$ \\
%     $\sur^3\ot+\te H\gas$ &\defskip$\rightarrow  \sur\hot$ & -285.37 & -250.56 & -222.36 & -195.29 & $^3\te O\tgas+\te H\gas$ &\defskip$\rightarrow  \te {HO}\tgas$\\[2pt]
%     
% \begin{table*}[h]
%   \centering
%   \caption{Add caption}
%     \begin{tabular}{ll|DD|DD}
%     %\hline
%     \multicolumn{2}{l|}{} & \multicolumn{2}{c|}{Surface Reaction} & \multicolumn{2}{c}{Gas phase reaction} \\
%     \multicolumn{2}{l|}{Reaction} & $E$ & $\ezp$ & $E$ & $\ezp$ \\[2pt]
%     \hline
%     & & & & \\[-10pt]
%     \multirow{8}{*}{
%     \begin{align*}
%     \sur\hto+^1\te O\gas &\rightarrow \sur\htot
%     \sur\ho+\ho\gas &\rightarrow \sur\htot
%     \sur\ho+\te H\gas &\rightarrow  \sur\hto
%     \sur\ho+^3\te O\gas &\rightarrow  \sur\hot
%     \sur^3\te O+\ho\gas &\rightarrow  \sur\hot
%     \sur\hot+\te H\gas &\rightarrow  \sur\htot
%     \sur^1\ot+\te H\gas &\rightarrow  \sur\hot
%     \sur^3\ot+\te H\gas &\rightarrow  \sur\hot
%     \end{align*}
%     }
%      & -1137.74 & -1128.81 & -1143.98 & -1130.33 \\
%     & -205.99 & -182.80 & -209.22 & -184.03 \\
%     & -512.17 & -475.86 & -509.16 & -475.57 \\
%     & -308.46 & -294.05 & -287.97 & -273.12 \\
%     & -337.30 & -314.13 & -287.97 & -273.12 \\
%     & -345.72 & -314.89 & -369.44 & -337.05 \\
%     & -441.66 & -406.73 & -384.59 & -357.44 \\
%     & -285.37 & -250.56 & -222.36 & -195.29 \\[2pt]
%     \hline
%     \end{tabular}%
%   \label{tab:addlabel}%
% \end{table*}%
