...
$M_{\te O}$ O atoms, we define a sort of non-literal atomisation energy by
\begin{equation}
...
only be given if the choice is not obvious. This is the case only for the
pure oxygen species in. All other species have singlet or dublet spin. 

The value is of no physical importance, but if two functionals
agree well, they should obviously agree well with respect to $E^0$.
...
data for these will make the results for the entire functional seem inaccurate.
But to have a first comparison of the functionals, we have to accept
these problems. 
...
Note that the formerly considered $\pw\dt$ functional is not included
in Table \ref{Gas:Energies}, since
the dispersion correction only affects intermolecular interaction.
Our calculations however treated isolated molecules. 

As we can see in Table \ref{Gas:Energies}, the approximative power
...
while the other functionals differ by less than $10~\kmo$.
Generally, all functionals predict too high values for $E^0$.
Since the values are not too far off for $\htw$ while showing
considerable problems with molecules composed solely of xygen,
...
\begin{table*}[htb]
  ...
  All energies in $\kmo$.}
    ...
    \hline \hline
      & & & & & & & & & \\[-10pt]
    $\ho\gas$&\defskip$+\ \te{H}\gas$&\defskip$\chemar\hto\gas$ & $E^{\zpe}$ & -475.58 & -454.56 & -470.70 & -470.94 & -478.89 & -491.23 \\
      & & & $E$   & -509.17 & -489.42 & -504.76 & -504.53 & -512.99 & -525.29 \\
      & & & $\Dl{E}^{\zpe}$ & 33.58 & 34.87 & 34.05 & 33.59 & 34.09 & 34.06 \\[2pt]
    \hline
       & & & & & & & & &  \\[-10pt]
    $\hto\gas$&\defskip$+^1\te{O}\gas$&\defskip$\chemar\hto\tgas$ & $E^{\zpe}$ & -402.09 & -355.15 & -425.77 & -426.60 & -403.33 & -342.42 \\
    & &    & $E$   & -415.75 & -370.59 & -440.19 & -439.92 & -417.56 & -355.80 \\
    & &    & $\Dl{E}^{\zpe}$ & 13.66 & 15.44 & 14.41 & 13.31 & 14.23 & 13.38 \\
    \hline
       & & & & & & & & &  \\[-10pt]
    $\ho\gas$&\defskip$+\ \ho\gas$&\defskip$\chemar\hto\tgas$ & $E^{\zpe}$ & -184.03 & -130.86 & -190.84 & -188.24 & -193.96 & -202.06 \\
      & & & $E$   & -209.22 & -158.07 & -216.83 & -213.19 & -219.86 & -227.13 \\
      & & & $\Dl{E}^{\zpe}$ & 25.19 & 27.21 & 25.99 & 24.94 & 25.90 & 25.07 \\[2pt]
    \hline
       & & & & & & & & &  \\[-10pt]
    $\te{HO}\tgas$&\defskip$+\ \te{H}\gas$&\defskip$\chemar\hto\tgas$ & $E^{\zpe}$ & -337.05 & -330.18 & -328.94 & -333.06 & -336.51 & -360.28 \\
      & & & $E$   & -369.45 & -364.20 & -362.04 & -365.28 & -369.52 & -392.71 \\
      & & & $\Dl{E}^{\zpe}$ & 32.40 & 34.02 & 33.11 & 32.22 & 33.01 & 32.44 \\[2pt]
    \hline
       & & & & & & & & &  \\[-10pt]
    $\ho\gas$&\defskip$+\ ^3\te{O}\gas$&\defskip$\chemar\te{HO}\tgas$ & $E^{\zpe}$ & -273.14 & -201.88 & -278.73 & -272.87 & -277.38 & -266.88 \\
      & & & $E$   & -287.98 & -218.17 & -294.10 & -287.56 & -292.69 & -281.88 \\
      & & & $\Dl{E}^{\zpe}$ & 14.84 & 16.29 & 15.36 & 14.69 & 15.31 & 15.00 \\[2pt]
    \hline
       & & & & & & & & &  \\[-10pt]
    $^1\te{O}\tgas$&\defskip$+\ \te{H}\gas$&\defskip$\chemar\te{HO}\tgas$ & $E^{\zpe}$ & -357.45 & -371.28 & -356.87 & -360.12 & -351.14 & -322.61 \\
      & & & $E$   & -384.60 & -399.86 & -384.50 & -387.18 & -378.72 & -350.98 \\
      & & & $\Dl{E}^{\zpe}$ & 27.14 & 28.58 & 27.63 & 27.06 & 27.58 & 28.36 \\[2pt]
    \hline
       & & & & & & & & &  \\[-10pt]
    $^3\te{O}\tgas$&\defskip$+\ \te{H}\gas$&\defskip$\chemar\te{HO}\tgas$ & $E^{\zpe}$ & -195.30 & -193.32 & -185.80 & -196.85 & -190.76 & -201.70 \\
...
Table \ref{Gas:Reactions} contains all the relevant information on
...
Only for the case of reaction \eqref{Gas:H2O+O->H2O2}, this is beneficial


%% CHECK: HERE WE ARE!
The results of Table \ref{Gas:Energies} already  

While the agreement between $\ccsdtf$ and the DFT functionals is never
better than a difference of $5~\kmo$, there are cases where the agreement
is particularly bad. 
...
\begin{table}[htb]
  ...
  \centering
    ...
    $\sur^3\te{O}$ & -16.17 & 2.69  & 3.35  & 3.04 \\
    $\sur^1\ot$ & -8.41 & 2.46  & 3.86  & 4.96 \\
    $\sur^3\ot$ & -2.62 & 3.06  & 3.90  & 3.86 \\[2pt]
    \hline
    \end{tabular}%
...
\begin{table*}[ht]
  ...
  Energies in $\kmo$.}
    ...
    $\sur^3\te{O}$ & -13.48 & -5.16 & -11.25 & -13.22 & -12.85 & -18.13 & -14.67\fakefnc\\
    $\sur^1\ot$ & -5.95 & -7.51 & -11.44 & -9.44 & -7.44 & -12.53 & -7.52\fakefnc,-$13.80\pm0.50$\fakefnd\\
    $\sur^3\ot$ & 0.45  & -0.65 & -1.52 & -0.52 & 26.68 & 7.04 & \\[2pt]
    \hline
 %   & & & & & & & \\[-10pt]
    \end{tabular}
    \\
...
\begin{table*}[htb]
  ...
  $\pws$ is short for $\pw$. The last column contains average values. The deviations of these are listed in the last four rows for each
  functional.}
    \begin{tabular}{lll|rrrrrr|r}
    & &    & \btlyp & \bhlyp & \pbez & \tpssh & \pws   & \pws\dt &  \multicolumn{1}{r}{$\avg$}  \\[2pt]
    %& &    & \btlyp & \bhlyp & \pbez & \tpssh & \pws   & \pws\dt &  $\Dl \eall_{\btlyps}$ & $\ering_{\btlyps}$ & $\Dl \ering_{\pbez}$ \\[2pt]
    \hline 
    & & & & & & & &\\[-10pt]
        $\sur\ho$&\defskip$+\te{H}\gas$&\defskip$\chemar\sur\hto$ & -476.22 & -458.03 & -472.39 & -470.76 & -480.13 & -480.92 & -473.07 \\
    $\sur\hto$&\defskip$+^1\te{O}\gas$&\defskip$\chemar\sur\htot$ & -402.54 & -357.85 & -427.27 & -426.38 & -405.24 & -407.50 & -404.46 \\
    $\sur\ho$&\defskip$+\ho\gas$&\defskip$\chemar\sur\htot$ & -185.12 & -137.04 & -194.02 & -187.84 & -197.12 & -200.16 & -183.55 \\
    $\sur\hot$&\defskip$+\te{H}\gas$&\defskip$\chemar\sur\htot$ & -317.22 & -318.69 & -310.31 & -309.82 & -320.89 & -323.99 & -316.82 \\
    $\sur\ho$&\defskip$+^3\te{O}\gas$&\defskip$\chemar\sur\hot$ & -294.05 & -219.54 & -300.54 & -295.71 & -296.15 & -296.10 & -283.68 \\
    $\sur^3\te{O}$&\defskip$+\ho\gas$&\defskip$\chemar\sur\hot$ & -311.96 & -248.31 & -325.41 & -313.50 & -316.45 & -318.00 & -305.61 \\
    $\sur^1\ot$&\defskip$+\te{H}\gas$&\defskip$\chemar\sur\hot$ & -403.80 & -414.31 & -402.88 & -404.70 & -395.22 & -396.95 & -402.98 \\
    $\sur^3\ot$&\defskip$+\te{H}\gas$&\defskip$\chemar\sur\hot$ & -248.05 & -243.27 & -241.72 & -250.31 & -268.95 & -256.14 & -251.41 \\[2pt]
